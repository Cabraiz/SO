 ...
 * @author Mateus
 */
public class LTG extends Builder {
                ...
                while (true) {
                    while (Apto_Exe) {
                        ...
                        try {
                            ...
                            Logger.getLogger(LTG.class.getName()).log(Level.SEVERE, null, ex);
                        }
                    }
                    try {
                        sleep(1000);
    ...
    private void initComponents() {
        ...
        Exe.setLayout(new java.awt.GridLayout());
        ...
        Ram.setLayout(new java.awt.GridLayout());
        ...
        HD.setLayout(new java.awt.GridLayout());
        ...
        Apto.setLayout(new java.awt.GridLayout());
        ...
        Finalizado.setLayout(new java.awt.GridLayout());
